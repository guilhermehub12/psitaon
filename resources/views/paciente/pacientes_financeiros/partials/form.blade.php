        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <x-admin.form-input type="text" name="valor_sessao" id="valor_sessao"
                        class="form-control {{ $errors->has('valor_sessao') ? 'is-invalid' : '' }}"
                        placeholder="Digite o valor da sessão" value="{{ old('valor_sessao') }}" />
                    <span class="text-danger">{{ $errors->first('valor_sessao') }}</span>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        function toggleFields() {
            const modalidade = $('#modalidade_pagamento_id').val().toLowerCase();
